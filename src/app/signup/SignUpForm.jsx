  ...
  return (
    <section className="bg-violet-950 p-6 rounded-lg max-w-[420px] w-full mx-auto shadow">
      <form onSubmit={handleSignup} className="flex flex-col items-start justify-around min-h-[30vh]">
        ...
        <input type="submit" value="Sign Up" className="bg-green-300 text-violet-950 py-2 px-8 rounded-lg shadow-lg transition duration-300 hover:bg-violet-300 hover:shadow-sm cursor-pointer w-full"/>
      </form>
      <button onClick={handleGoogle} className="mt-4 bg-sky-300 text-violet-950 py-2 px-8 rounded-lg shadow-lg transition duration-300 hover:bg-violet-300 hover:shadow-sm cursor-pointer">Signup with Google</button>
    </section>
  );
}
